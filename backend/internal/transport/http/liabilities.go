...
type LiabilityHandler struct{ repo repository.LiabilityRepo }

func NewLiabilityHandler(r repository.LiabilityRepo) *LiabilityHandler { return &LiabilityHandler{r} }

func validateLiability(l wealth.Liability) string {
	if l.Name == "" {
