...
// mockGCalEventRepo implements repository.EventRepo for testing.
type mockGCalEventRepo struct{ upserted int }

func (m *mockGCalEventRepo) List(_ context.Context, _, _, _ string) ([]calendar.Event, error) {
	return []calendar.Event{}, nil
}
func (m *mockGCalEventRepo) Create(_ context.Context, e calendar.Event) (calendar.Event, error) {
	e.ID = "new"
	return e, nil
}
func (m *mockGCalEventRepo) Update(_ context.Context, e calendar.Event) (calendar.Event, error) {
	return e, nil
}
func (m *mockGCalEventRepo) Delete(_ context.Context, _, _ string) error { return nil }
func (m *mockGCalEventRepo) UpsertFromGoogle(_ context.Context, _ string, evts []calendar.Event) (int, error) {
	m.upserted = len(evts)
	return len(evts), nil
}
