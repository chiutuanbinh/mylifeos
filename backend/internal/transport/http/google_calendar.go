...
type GoogleCalendarHandler struct{ repo repository.EventRepo }

func NewGoogleCalendarHandler(r repository.EventRepo) *GoogleCalendarHandler {
...
func mapGCalEvent(ge gcalEvent) calendar.Event {
