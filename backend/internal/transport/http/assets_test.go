...
func (m *mockAssetRepo) List(_ context.Context, _ string) ([]wealth.Asset, error) {
	pv := 12000.0
	return []wealth.Asset{{ID: "a-1", Name: "Car", Category: "vehicle", Value: 10000, PurchaseValue: &pv, DepreciationRate: 0.15, CurrentValue: 9800}}, nil
}
func (m *mockAssetRepo) Create(_ context.Context, a wealth.Asset) (wealth.Asset, error) {
	a.ID = "a-new"
	return a, nil
}
func (m *mockAssetRepo) Update(_ context.Context, a wealth.Asset) (wealth.Asset, error) { return a, nil }
...
func TestAssetList(t *testing.T) {
	devEnv(t)
	h := httphandler.NewAssetHandler(&mockAssetRepo{})
