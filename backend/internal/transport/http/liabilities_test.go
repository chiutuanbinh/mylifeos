...
func (m *mockLiabilityRepoErr) List(_ context.Context, _ string) ([]wealth.Liability, error) {
	return nil, errLiabilityInternal
}
func (m *mockLiabilityRepoErr) Create(_ context.Context, l wealth.Liability) (wealth.Liability, error) {
	return l, errLiabilityInternal
}
func (m *mockLiabilityRepoErr) Update(_ context.Context, l wealth.Liability) (wealth.Liability, error) {
	return l, errLiabilityInternal
}
...
func (m *mockLiabilityRepo) List(_ context.Context, _ string) ([]wealth.Liability, error) {
	ir := 0.085
	return []wealth.Liability{{ID: "l-1", Name: "Car Loan", Category: "Car Loan", Balance: 200000000, InterestRate: &ir}}, nil
}
func (m *mockLiabilityRepo) Create(_ context.Context, l wealth.Liability) (wealth.Liability, error) {
	l.ID = "l-new"
	return l, nil
}
func (m *mockLiabilityRepo) Update(_ context.Context, l wealth.Liability) (wealth.Liability, error) {
	return l, nil
}
...
func TestLiabilityList(t *testing.T) {
	devEnv(t)
	h := httphandler.NewLiabilityHandler(&mockLiabilityRepo{})
...
func TestLiabilityList_RepoError(t *testing.T) {
	devEnv(t)
	h := httphandler.NewLiabilityHandler(&mockLiabilityRepoErr{})
	handler := middleware.Auth(http.HandlerFunc(h.List))
