...
func (m *mockEventRepo) List(_ context.Context, _, _, _ string) ([]models.Event, error) {
	return []models.Event{{
		ID:      "evt-1",
		UserID:  "user-1",
		Title:   "Test",
...
func (m *mockEventRepo) Create(_ context.Context, e models.Event) (models.Event, error) {
	e.ID = "evt-new"
	return e, nil
}

func (m *mockEventRepo) Update(_ context.Context, e models.Event) (models.Event, error) {
	return e, nil
}

func (m *mockEventRepo) Delete(_ context.Context, _, _ string) error { return nil }

func (m *mockEventRepo) UpsertFromGoogle(_ context.Context, _ string, events []models.Event) (int, error) {
