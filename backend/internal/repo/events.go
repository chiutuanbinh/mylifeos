...
type EventRepo interface {
	...
	UpsertFromGoogle(ctx context.Context, userID string, events []models.Event) (int, error)
}
...
func (r *pgEventRepo) UpsertFromGoogle(ctx context.Context, userID string, events []models.Event) (int, error) {
	count := 0
