...
function TrendsTab() {
  ...
  const addMutation = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['net-worth-snapshots'] }); qc.invalidateQueries({ queryKey: ['dashboard'] }); setBackfillOpen(false); form.resetFields() },
  })
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Balance indicator — uses shouldUpdate so it re-renders on every amount/side change */}
